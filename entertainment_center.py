...
back_to_the_future = media.Movie("Back To The Future",
                                  ...
                                  high school student, is accidentally sent
                                  thirty years into the past in a time-traveling
...
catch_me_if_you_can = media.Movie("Catch Me If You Can",
                                  """A seasoned FBI agent pursues Frank Abagnale
                                  Jr. who, before his 19th birthday,
                                  successfully forged millions of dollars' worth
                                  of checks while posing as a Pan Am pilot,
                                  a doctor, and a legal prosecutor.""",
...
full_metal_jacket = media.Movie("Full Metal Jacket",
                                  ...
                                  camp training to the bloody street fighting in
                                  Hue.""",
...
se7en = media.Movie("Se7en",
                    """Two detectives, a rookie and a veteran, hunt
...
the_prestige = media.Movie("The Prestige",
                                  ...
                                  illusion whilst sacrificing everything they
                                  have to outwit the other.""",
